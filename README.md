...
- Disabled FYT support - I had to modify the code slightly and I'm not sure if it will still work on FYT
- Reading titles from build in k706 apps: fm radio, music player, bt music player
- Added outlined typeface for better readability

App requires root and disabled signature veryfication: I use: [PMPatch](https://github.com/vova7878-modules/PMPatch).

<img src="./images/rocok706.JPEG" width="30%">
